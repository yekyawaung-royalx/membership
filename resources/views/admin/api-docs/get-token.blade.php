                                ...
                                <div class="row">
                                                        <div class="col-md-8">
                                                                <h5 class="py-2 mb-2">
                                                                        ...
                                                                        <span class="text-muted fw-light">> Get Member Token API</span> 
                                                                </h5>
                                                        </div>
                                                        <div class="col-md-4">
                                                      ...
                                                      <div class="card mb-4">
                                                        ...
                                                        <div>
                                                          ...
                                                          <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ url('api/get-token')}}" aria-label="register" aria-describedby="basic-addon11">
                                                          </div>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <div class="border rounded mb-4">
                                                                <div class="card-body">
                                                                  <p class="text-primary">
                                                                    {<br>
                                                                       <span class="text-indent-20">"login":"E1810913",</span><br>
                                                                       <span class="text-indent-20">"passcode":"123456"</span><br>
                                                                    }<br>
                                                                </p>
                                                                </div>
                                                              </div>
                                                                    ...
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        {<br>
                                                                            ...
                                                                            <span class="text-indent-60">"token": "lcSyy0KlwcgLPPrgrbSe4MhJJ/0LmmhFqv5wVEgMOSg=",</span><br>
                                                                            <span class="text-indent-60">"expired_at": "2024-06-12 10:03:31"</span><br>
                                                                            <span class="text-indent-20">}</span><br>
                                                                        }<br>    
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <div class="border rounded mb-4">
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        {<br>
                                                                            <span class="text-indent-20">"success": 1,</span><br>
                                                                            <span class="text-indent-20">"message": "These credentials do not match our records."</span><br>
                                                                        }<br>    
                                                                        </p>
                                                                    </div>
                                                                  </div>
