                                ...
                                <div class="row">
                                                        <div class="col-md-8">
                                                                <h5 class="py-2 mb-2">
                                                                        ...
                                                                        <span class="text-muted fw-light">> Member Passcode Change</span> 
                                                                </h5>
                                                        </div>
                                                        <div class="col-md-4">
                                                      ...
                                                      <div class="card mb-4">
                                                        ...
                                                        <div>
                                                          ...
                                                          <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ url('api/passcode-change')}}" aria-label="register" aria-describedby="basic-addon11">
                                                          </div>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <div class="border rounded mb-4">
                                                                <div class="card-body">
                                                                  <p class="text-primary">
                                                                    {<br>
                                                                       <span class="text-indent-20">"membership_id":1538,</span><br>
                                                                        <span class="text-indent-20">"old_passcode":"123456",</span><br>
                                                                        <span class="text-indent-20">"new_passcode":"123456"</span><br>
                                                                    }<br>
                                                                </p>
                                                                </div>
                                                              </div>
...
echo $response;<br>
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="card mb-4">
                                                        ...
                                                        <div class="card-body demo-vertical-spacing demo-only-element">
                                                            <div>
                                                                <label class="form-label w-100">JSON Response <span class="pull-right">Status <span class="badge bg-label-success">Success</span> &nbsp; Code <span class="badge badge-sm badge-rounded bg-label-info">200</span></span></label>
                                                                <div class="border rounded mb-0">
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        {<br>
                                                                            <span class="text-indent-20">"success": 1,</span><br>
                                                                            <span class="text-indent-20">"message": "New passcode has been changed."</span><br>
                                                                        }<br>    
                                                                        </p>
                                                                    </div>
                                                                  </div>
                                                        ...
                                                        <div class="card-body demo-vertical-spacing demo-only-element">
                                                            <div>
                                                                <label class="form-label w-100">JSON Response <span class="pull-right">Status <span class="badge bg-label-danger">Failed</span>&nbsp; Code <span class="badge badge-sm badge-rounded bg-label-danger">401</span></span></label>
                                                                <div class="border rounded mb-4">
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        {<br>
                                                                            <span class="text-indent-20">"success": 0,</span><br>
                                                                            <span class="text-indent-20">"message": "Token is invalid."</span><br>
                                                                        }<br>    
                                                                        </p>
                                                                    </div>
                                                                  </div>
