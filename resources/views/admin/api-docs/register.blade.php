                                ...
                                <div class="row">
                                                        <div class="col-md-8">
                                                                <h5 class="py-2 mb-2">
                                                                        ...
                                                                        <span class="text-muted fw-light">> New Member Register API</span> 
                                                                </h5>
                                                        </div>
                                                        <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                      ...
                                                      <div class="card mb-4">
                                                        ...
                                                        <div>
                                                          ...
                                                          <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ url('api/register')}}" aria-label="register" aria-describedby="basic-addon11">
                                                          </div>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <div class="border rounded mb-4">
                                                                <div class="card-body">
                                                                  <p class="text-primary">
                                                                    {<br>
                                                                      <span class="text-indent-20">"name":"YeKyawAung",</span><br>
                                                                      <span class="text-indent-20">"mobile":"09450049715",</span><br>
                                                                      <span class="text-indent-20">"passcode":"739561",</span><br>
                                                                      <span class="text-indent-20">"gender":"male",</span><br>
                                                                      <span class="text-indent-20">"dob":"1991-07-10",</span><br>
                                                                      <span class="text-indent-20">"nrc":"10/YAMANA(N)162891",</span><br>
                                                                      <span class="text-indent-20">"state":"Yangon",</span><br>
                                                                      <span class="text-indent-20">"city":"Yangon",</span><br>
                                                                      <span class="text-indent-20">"township":"Botahtaung",</span><br>
                                                                      <span class="text-indent-20">"address":"Botahtaung",</span><br>
                                                                      <span class="text-indent-20">"nrc_front_photo":"https://firebasestorage.googleapis.com/...",</span><br>
                                                                      <span class="text-indent-20">"nrc_back_photo":"https://firebasestorage.googleapis.com/...",</span><br>
                                                                      <span class="text-indent-20">"selfie_photo":"https://firebasestorage.googleapis.com/..."</span><br>
                                                                    }<br>
                                                                </p>
                                                                </div>
                                                              </div>
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="card mb-4">
                                                        <h5 class="card-header">Response <small class="pull-right">Status: <span class="badge badge-sm badge-rounded bg-label-info">201</span></small></h5>
                                                        <div class="card-body demo-vertical-spacing demo-only-element">
                                                            <div>
                                                                    ...
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        {<br>
                                                                            ...
                                                                            <span class="text-indent-20">"message": "New member has been registered",</span><br>
                                                                            <span class="text-indent-20">"data": {</span><br>
                                                                            <span class="text-indent-60">"id": 1,</span><br>
                                                                            <span class="text-indent-60">"name": "YeKyawAung",</span><br>
                                                                            <span class="text-indent-60">"mobile": "09450049715",</span><br>
                                                                            <span class="text-indent-60">"ecode": null,</span><br>
                                                                            <span class="text-indent-60">"token": "pyN8Sp4zYTQ8dtbBRvsCJApOukhtuBElSKJUlrufUdQ=",</span><br>
                                                                            <span class="text-indent-60">"expired_at": "2024-06-29 08:06:29"</span><br>
                                                                    ...
                                                                    <div class="card-body">
                                                                      <p class="text-primary">
                                                                        ...
                                                                        {<br>
                                                                            ...
                                                                            <span class="text-indent-20">"message": {</span><br>
                                                                            <span class="text-indent-60">"nrc is required",</span><br>
                                                                            <span class="text-indent-60">"dob is required"</span><br>
                                                                            <span class="text-indent-20">}</span><br>
                                                                        }<br>
                                                                    </p>
                                                                    </div>
