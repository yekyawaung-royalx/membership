							...
							<div class="row">
				                <div class="col-md-4">
				                    <h5 class="py-2 mb-2">
                                    	...
                                    	<span class="text-muted fw-light text-capitalize">> Regions</span> 
				              		</h5>
				                </div>
				                <div class="col-md-8">
				                ...
				                <div class="card-body results hide">
					                <div class="table-responsive text-nowrap">
					                    <table class="table">
					                        <thead>
        					                    <tr>
                                                    <th class="text-muted unset">MM Name</th>
                                                    <th class="text-muted unset">En Name</th>
        					                        <th class="text-muted unset">PostalCode</th>
        					                        <th class="text-muted unset">RegionCode</th>
        					                        <th class="text-muted unset">Total Townships</th>
						...
						if(data.total > 0){
		                    $.each(data.data, function (i, item) {
		                       	$("#fetched-data").append('<tr>'
									+'<td class="text-primary">'+item.mm_name+'</span></td>'
		                            +'<td class="text-primary">'+item.en_name+'</td>'
		                            +'<td class="text-muted"><span class="badge bg-primary">'+item.postal_code+'</span></td>'
		                            +'<td class="text-muted">'+item.region_code+'</td>'
                                    +'<td class="text-muted">'+item.total_townships+'</td>'
		                            +'<td>'
		                                +'<div class="btn-group">'
