									...
									<div class="col-md-6">
										<div class="card card-border-shadow-primary h-100">
											<div class="card-body">
												<div class="row">
													<div class="col-md-6">
														<div class="text-center" cursorshover="true">
															<img src="{{ asset('_backend/_images/user.jpg') }}" alt="Avatar" class="rounded-circle selfie {{ $member->user_level == 1? 'silver-badge':'gold-badge'}}" cursorshover="true">
															<h4 class="user-level text-primary">Level <span class="label-user-level">{{ $member->user_level }}</span></h4>
														</div>
													</div>
													<div class="col-md-6">
														<div class="me-2">
															<small class="text-muted d-block mb-1">Gender</small>
															<h6 class="mb-0">{{ $member->gender }}&nbsp;</h6>
														</div>
														<div class="me-2 mt-4">
												...
												<div class="mt-4">
													<button type="button" class="btn btn-success btn-sm show-btn-register {{ $member->icode == null? '':'hide' }}" data-bs-toggle="modal" data-bs-target="#RegisterModal" cursorshover="true">Register</button>
													...
													<button type="button" class="btn btn-danger btn-sm {{ $member->icode != null? 'hide':'' }}" cursorshover="true">Rejected</button>
												...
												<div class="row">
													<div class="col-md-12 mb-2">
														...
														<div class="card w-400p">
															<img class="card-img" src="{{ asset('_backend/_images/nrc-front.jpg') }}" alt="Card image cap">
														</div>
													</div>
													<div class="col-md-12 mb-2">
														<h5 class="mt-4 mb-1">NRC Back Side</h5>
														<div class="card w-400p">
														<img class="card-img" src="{{ asset('_backend/_images/nrc-back.jpg') }}" alt="Card image cap">
														</div>
													</div>
												</div>
											</div>
