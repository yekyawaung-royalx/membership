...
<head>
  	...
  	<title>Membership | Member Tokens</title>
							...
							<div class="row">
				                <div class="col-md-4">
				                    <h5 class="py-2 mb-2">
                                    	...
                                    	<span class="text-muted fw-light text-capitalize">> Member Tokens</span> 
				              		</h5>
				                </div>
				                <div class="col-md-8">
				                ...
				                <div class="card-body results hide">
					                <div class="table-responsive text-nowrap">
					                    <table class="table">
					                        <thead>
        					                    <tr>
                                                    <th class="text-muted unset">Icode</th>
                                                    <th class="text-muted unset">Name</th>
        					                        <th class="text-muted unset">Registered At</th>
        					                        <th class="text-muted unset">Expired At</th>
        					                        <th class="text-muted unset">Token</th>
        					                    </tr>
					                        </thead>
						...
						if(data.total > 0){
		                    $.each(data.data, function (i, item) {
		                       	$("#fetched-data").append('<tr>'
									+'<td><a href="'+url+'/members/view/'+item.id+'" class="btn btn-primary btn-sm">'+item.icode+'</a></td>'
									+'<td>'+item.name+'</td>'
                                    +'<td class="text-muted">'+item.created_at+'</td>'
		                            +'<td class="text-muted">'+item.expired_at+'</td>'
                                    +'<td class="text-muted">'+item.token+'</td>'
		                        +'</tr>');
		                    });
