...
<head>
    ...
    <title>Membership | Push Notifications</title>
                            	...
                            	<div class="row">
                                                        <div class="col-md-4">
                                                                <h5 class="py-2 mb-2">
                                                                        ...
                                                                        <span class="text-muted fw-light">> Push Notifications</span> 
                                                                </h5>
                                                        </div>
                                                        <div class="col-md-8">
...
<form action="{{ route('send.notification') }}" method="POST">
	@csrf
      	<div class="row">
                            <div class="col mb-3">
                                <label for="new-registration-no" class="form-label text-primary">Title<span class="text-danger">*</span></label>
                                <input type="text" name="title" id="new-registration-no" class="form-control border-danger" placeholder="Noti Title">
                            </div>
                    </div>

                    <div class="row">
                        <div class="col mb-3">
                            <label for="new-type-name" class="form-label text-primary">Content <span class="text-danger">*</span></label>
                            <textarea  class="form-control" name="body" placeholder="Noti Content"></textarea>
                        </div>
                    </div>
                    <div class="row">
                    	<div class="col">
                    		<button type="submit"  class="btn btn-primary btn-create ">Send</button>
                    	</div>
                    </div>
            </form>
      </div>
